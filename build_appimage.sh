...
APPDIR="$BUILDDIR/electrum-${name}.AppDir"
...
APPIMAGE="$DISTDIR/${name}-Electrum-$VERSION-x86_64.AppImage"
...
info "installing electrum-${name} and its dependencies."
...
# add launcher
cp "$CONTRIB/${name}/travis/apprun.sh" "$APPDIR/AppRun"
