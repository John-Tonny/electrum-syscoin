...
;Variables
  ...
  !define PRODUCT_NAME "Vds Electrum"
  !define PRODUCT_NAME_NO_SPACE "Vds-Electrum"
  !define PREV_PROD_NAME "Electrum-VDS"
  !define PREV_PROD_NAME2 "Vds-Electrum"
...
;--------------------------------
;Descriptions
LangString DESC_DE ${LANG_ENGLISH} "Vds Electrum Wallet"
